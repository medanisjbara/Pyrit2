...
PyObject *cpyrit_cuda(PyObject *self, PyObject *args)
{
    ...
    {
        const char *key = PyUnicode_AsUTF8(PyList_GetItem(listObj, line));
    ...
    for (i = 0; i < numLines; i++)
    {
        ...
        PyList_SetItem(destlist, i, Py_BuildValue("(s,s#)", PyUnicode_AsUTF8(PyList_GetItem(listObj, i)), temp, 32));
    }    
    free(c_outbuffer);
